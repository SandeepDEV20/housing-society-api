 ...
 function send_mail($recipients, $subject, $message,$cc_recipients='', $from=''){
    ...
    $mail->Username   = 'support@indovisionservices.com';  // GMAIL username
    $mail->Password   = '1qaz2wsx';            // GMAIL password
    //$mail->SMTPSecure = 'tls';
    $mail->SetFrom("support@indovisionservices.com","Mikuni India");
    $mail->AddReplyTo("noreply@indovisionservices.com","Reply : ");
